...
import { User, Mail, Lock, Save, ShieldCheck, Image as ImageIcon } from 'lucide-react';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.put(
                ...
                { name, email, currentPassword, newPassword, profileImage },
                config
            );
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-4">
            <div className="mb-8">
                ...
                <p className="text-gray-500 mt-2 font-medium">Manage your personal information and account security.</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Profile Card */}
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl shadow-blue-900/5 flex flex-col items-center text-center">
                        ...
                        <p className="text-blue-600 text-sm font-black uppercase tracking-widest mt-1">{user?.role}</p>

                        <div className="w-full mt-8 space-y-4 pt-8 border-t border-gray-50">
                ...
                <div className="lg:col-span-2">
                    <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl shadow-blue-900/5 space-y-8">
                        <div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-blue-600/20 focus:bg-white transition-all text-sm font-bold"
                                            required
                                        />
                                    </div>
                                </div>
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-gray-900 mb-6 flex items-center gap-2 pt-4 border-t border-gray-50">
